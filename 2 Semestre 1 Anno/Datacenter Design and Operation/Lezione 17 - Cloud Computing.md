...
>
> - Quali sono le 5 caratteristiche essenziali del cloud secondo il NIST? Spiega ciascuna con un esempio pratico.
> - Qual è la differenza tra IaaS, PaaS e SaaS? Chi gestisce cosa in ciascun modello?
> - Cosa si intende per cloud pubblico, privato, ibrido e community? Cosa distingue un cloud privato da uno pubblico?
> - Descrivi il Cloud Computing Reference Model: quali layer contiene e quali sono le dimensioni cross-cutting?
> - Cos'è la rapid elasticity e in cosa differisce dalla scalabilità?
> - Cos'è uno SLA e perché è cruciale nel contesto cloud?
> - Cosa significa greenfield vs brownfield nel contesto del deployment cloud?
> - Cos'è il chargeback e quali modelli di pricing esistono?
> - Cosa si intende per vendor lock-in e come si può mitigare?
